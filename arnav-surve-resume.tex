...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {(Incomplete) Bachelor of Science, Cybersecurity -- Dean's List, Fall 2023}{Aug. 2022 -- May 2024}
      \resumeProjectHeading
...
\section{Projects}
  \resumeSubHeadingListStart
    \resumeProjectHeading
        {\textbf{taskman} $|$ \emph{Go, Gin, PostgreSQL, Docker}}{Aug. 2024 - Current}
        \resumeItemListStart
          \resumeItem{Independently developed a full stack CLI task management solution using Go and the Gin web framework,
            providing RESTful APIs for task and user management.}
          \resumeItem{Designed PostgreSQL database schemas, including user-specific tables with foreign key relationships.}
          \resumeItem{Implemented user session authentication and authorization using JWT, securing access to protected endpoints.}
          \resumeItem{Created robust error handling and validation mechanisms for API endpoints, enhancing reliability and UX.}
          \resumeItem{Automated build, testing, and deployment process using Makefile and containerized backend service with Docker.}
        \resumeItemListEnd

    \resumeProjectHeading
        {\textbf{lastfm-crawl} $|$ \emph{Python, Flask, AWS Lambda, Docker}}{July 2024}
        \resumeItemListStart
          \resumeItem{Developed a wrapper for the Last.fm API as an easier way to embed Last.fm stats in a website or application.}
